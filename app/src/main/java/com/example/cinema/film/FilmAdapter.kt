...
class FilmAdapter(var list: MutableList<RaterMOvData>): RecyclerView.Adapter<FilmAdapter.RvViev>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RvViev {
     Log.d("RvAdapter","onCreateViewHolder")
        return RvViev(LayoutInflater.from(parent.context).inflate(R.layout.film_recomend_item,parent,false))
    }
